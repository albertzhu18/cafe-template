...
export const siteConfig = {
  ...
  tagline: "Aromatic Coffee. Cozy vibes. Real people.",
  mission:
    "Aromatic Coffee. Cozy vibes. Real people. We strive to be a neighbourhood cafe where anyone can enjoy some peace and quiet.",
  description:
